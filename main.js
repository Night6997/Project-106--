...
function getResults(error, result){
    ...
    if(error){
        ...
        document.getElementById("result_Detected").innerHTML = ' '+ result[0].label; 
        document.getElementById("result_accuracy").innerHTML = 'Accuracy - '+ (result[0].confidence*100).toFixed(2)+" %";
        document.getElementById("result_Detected").style.color="rgb("+color_r+","+color_g+","+color_b+")";
    ...
    if(result[0].label=="dog"){
        ...
        document.getElementById("result_Voice").innerHTML="Dog"; //fix sentences//
    ...
    if(result[0].label=="cat"){
        ...
        document.getElementById("result_Voice").innerHTML="Cat";
    ...
    if(result[0].label=="owl"){
        ...
        document.getElementById("result_Voice").innerHTML="Owl";
